...
public class Hw_ActitimeTestNG {
	
	WebDriver dr;
	@BeforeClass
	public void beforeClass()
	{
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Rushikesh\\Downloads\\chromedriver_win32\\chromedriver.exe");
	    dr = new ChromeDriver();
	}
	@BeforeMethod
	public void beforeMethod() throws InterruptedException
	{
	    ...
	    dr.findElement(By.id("username")).sendKeys("rushikeshyengupatla@gmail.com");
		dr.findElement(By.name("pwd")).sendKeys("RUSHIKESH@26",Keys.ENTER);
	}
